    ...
    <div className=" h-[700px] w-full m-auto  relative group">
      ...
      >
        <div className="w-full h-full justify-center items-center text-center flex flex-col bg-black/20  rounded-2xl">
          <h1
            className={` transition-opacity duration-1000 ease-in-out text-[50px] md:text-[80px]  text-white mb-4 ${
          ...
          <h2
            className={` transition-opacity duration-1000 ease-in-out text-[20px] md:text-[30px] text-white ${
              textVisible ? "opacity-100" : "opacity-0"
            }`}
          >
